...
class AIotSpace:
    ...
    def run(self):
        ...
        if aiot_ir_state == 0:
            ...
            db.aiotIrInsert(information.ir2, timestamp, information.detect)
            ...
            if bulb_status != bulb_current_status:
                ...
                db.aiotBulbInsert(information.bulb2, bulb_runtime)
        ...
        if temperature > 30.0:
            ...
            db.aiotDhtInsert(information.dht2, timestamp, temperature, humidity)
            ...
            if fan_status != fan_current_status:
                ...
                db.aiotFanInsert(information.fan2, fan_runtime)
